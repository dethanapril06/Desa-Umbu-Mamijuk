    ...
    public function run(): void
    {
        ...
        DB::table('wisata')->updateOrInsert(
            ...
            [
                ...
                'nama' => 'XXXXX',
                'deskripsi_singkat' => 'Lorem ipsum dolor sit amet consectetur adipisicing elit. Non, laborum.',
                'deskripsi' => '<p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Non, laborum.</p><p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Non, laborum.</p>',
                'highlight_quote' => 'Lorem ipsum dolor sit amet consectetur adipisicing elit. Non, laborum.',
