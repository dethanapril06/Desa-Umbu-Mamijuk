...
class PendudukController extends Controller
{
    ...
    public function store(Request $request): RedirectResponse
    {
        ...
        $rules = [
            ...
            'pendidikan_terakhir' => 'required|in:tidak_sekolah,sd,smp,sma,d1,d2,d3,s1,s2,s3',
            'pekerjaan' => 'required|string|max:100',
            'status_perkawinan' => 'required|in:belum_kawin,kawin,cerai_hidup,cerai_mati',
            'status_hubungan_keluarga' => 'required|in:kepala_keluarga,istri,anak,menantu,cucu,orang_tua,mertua,famili_lain,lainnya',
        ...
        $messages = [
            ...
            'nama_ayah.required' => 'Nama lengkap ayah wajib diisi.',
