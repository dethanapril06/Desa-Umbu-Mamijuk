                ...
                <form action="{{ route('admin.mutasi-penduduk.update', $mutasiPenduduk->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" id="masuk_nik" name="masuk_nik" 
                                    value="{{ old('masuk_nik', optional($mutasiPenduduk->penduduk)->nik) }}" placeholder="16 digit NIK" maxlength="16" inputmode="numeric" autocomplete="off" />
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" id="masuk_no_kitas_kitap" name="masuk_no_kitas_kitap" 
                                    value="{{ old('masuk_no_kitas_kitap', optional($mutasiPenduduk->penduduk)->no_kitas_kitap) }}" placeholder="No. KITAS/KITAP (jika ada)" inputmode="numeric" autocomplete="off" />
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="date" class="form-control" id="tanggal_mutasi" name="tanggal_mutasi" value="{{ old('tanggal_mutasi', $mutasiPenduduk->tanggal_mutasi ? $mutasiPenduduk->tanggal_mutasi->format('Y-m-d') : '') }}" />
                        </div>
                        <div class="col-md-6 mb-3">
