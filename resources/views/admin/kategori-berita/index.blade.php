            ...
            <div class="table-responsive text-nowrap">
                <table class="table table-hover">
                    ...
                    <tbody class="table-border-bottom-0">
                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu">
                                            <a class="dropdown-menu-item dropdown-item" href="{{ route('admin.kategori-berita.edit', $kategori->id) }}">
                        ...
                        @empty
                            <tr>
                                <td colspan="4" class="text-center py-4">Tidak ada data kategori berita.</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
