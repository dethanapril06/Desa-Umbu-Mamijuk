...
<div class="row">
    <div class="col-12 col-md-8 offset-md-2">
        <h4 class="fw-bold py-3 mb-4">
            <span class="text-muted fw-light">Dusun /</span> Edit Dusun
        </h4>

        <div class="card mb-4">
            <div class="card-header d-flex justify-content-between align-items-center">
                <h5 class="mb-0">Form Edit Dusun</h5>
            ...
            <div class="card-body">
                ...
                <form action="{{ route('admin.dusun.update', $dusun->id) }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="nama" name="nama" value="{{ old('nama', $dusun->nama) }}" required />
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control" id="urutan" name="urutan" value="{{ old('urutan', $dusun->urutan) }}" min="0" required />
                    </div>

                    <div class="mb-3 form-check">
                        <input type="checkbox" class="form-check-input" id="is_active" name="is_active" value="1" {{ old('is_active', $dusun->is_active) ? 'checked' : '' }}>
