...
<div class="row">
    <div class="col-12">
        <h4 class="fw-bold py-3 mb-4">
            <span class="text-muted fw-light">Penduduk /</span> Edit Penduduk
        </h4>
                    ...
                    <div class="card h-100 mb-4">
                        ...
                        <div class="card-body pt-3">
                            <div class="mb-3">
                                ...
                                <select class="form-select" id="keluarga_id" name="keluarga_id" required>
                                    @foreach($keluargaList as $kk)
                                        ...
                                        @endphp
                                        <option value="{{ $kk->id }}" {{ old('keluarga_id', $penduduk->keluarga_id) == $kk->id ? 'selected' : '' }}>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="nik" name="nik" value="{{ old('nik', $penduduk->nik) }}" maxlength="16" required />
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control" id="tempat_lahir" name="tempat_lahir" value="{{ old('tempat_lahir', $penduduk->tempat_lahir) }}" />
                                </div>
                                <div class="col-md-6 mb-3">
                                    <label class="form-label" for="tanggal_lahir">Tanggal Lahir</label>
                                    <input type="date" class="form-control" id="tanggal_lahir" name="tanggal_lahir" value="{{ old('tanggal_lahir', $penduduk->tanggal_lahir ? $penduduk->tanggal_lahir->format('Y-m-d') : '') }}" />
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control" id="no_telepon" name="no_telepon" value="{{ old('no_telepon', $penduduk->no_telepon) }}" />
                                </div>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select" id="status_hubungan_keluarga" name="status_hubungan_keluarga" required>
                                    ...
                                    <option value="menantu" {{ old('status_hubungan_keluarga', $penduduk->status_hubungan_keluarga) == 'menantu' ? 'selected' : '' }}>Menantu</option>
                                    <option value="cucu" {{ old('status_hubungan_keluarga', $penduduk->status_hubungan_keluarga) == 'cucu' ? 'selected' : '' }}>Cucu</option>
                                    <option value="orang_tua" {{ old('status_hubungan_keluarga', $penduduk->status_hubungan_keluarga) == 'orang_tua' ? 'selected' : '' }}>Orang Tua</option>
                                    <option value="mertua" {{ old('status_hubungan_keluarga', $penduduk->status_hubungan_keluarga) == 'mertua' ? 'selected' : '' }}>Mertua</option>
                                    <option value="famili_lain" {{ old('status_hubungan_keluarga', $penduduk->status_hubungan_keluarga) == 'famili_lain' ? 'selected' : '' }}>Famili Lain</option>
                                    <option value="lainnya" {{ old('status_hubungan_keluarga', $penduduk->status_hubungan_keluarga) == 'lainnya' ? 'selected' : '' }}>Lainnya</option>
                                </select>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card-body pt-3">
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select class="form-select" id="pendidikan_terakhir" name="pendidikan_terakhir">
                                        ...
                                        <option value="tidak_sekolah" {{ old('pendidikan_terakhir', $penduduk->pendidikan_terakhir) == 'tidak_sekolah' ? 'selected' : '' }}>Tidak / Belum Sekolah</option>
                                        <option value="sd" {{ old('pendidikan_terakhir', $penduduk->pendidikan_terakhir) == 'sd' ? 'selected' : '' }}>SD / Sederajat</option>
                                        <option value="smp" {{ old('pendidikan_terakhir', $penduduk->pendidikan_terakhir) == 'smp' ? 'selected' : '' }}>SMP / Sederajat</option>
                                        <option value="sma" {{ old('pendidikan_terakhir', $penduduk->pendidikan_terakhir) == 'sma' ? 'selected' : '' }}>SMA / Sederajat</option>
                                        ...
                                        <option value="s1" {{ old('pendidikan_terakhir', $penduduk->pendidikan_terakhir) == 's1' ? 'selected' : '' }}>S1 / Diploma IV</option>
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control" id="no_paspor" name="no_paspor" value="{{ old('no_paspor', $penduduk->no_paspor) }}" />
                                </div>
                                <div class="col-md-6 mb-3">
                                    <label class="form-label" for="no_kitas_kitap">No. KITAS / KITAP</label>
                                    <input type="text" class="form-control" id="no_kitas_kitap" name="no_kitas_kitap" value="{{ old('no_kitas_kitap', $penduduk->no_kitas_kitap) }}" />
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card-body pt-3">
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control" id="nama_ayah" name="nama_ayah" value="{{ old('nama_ayah', $penduduk->nama_ayah) }}" />
                                </div>
                                <div class="col-md-6 mb-3">
                                    <label class="form-label" for="nama_ibu">Nama Lengkap Ibu</label>
                                    <input type="text" class="form-control" id="nama_ibu" name="nama_ibu" value="{{ old('nama_ibu', $penduduk->nama_ibu) }}" />
                                </div>
                            </div>
                            ...
                            <div class="row border-top pt-3 mt-3">
                                <div class="col-md-4 mb-3 d-flex flex-column justify-content-center">
                                    <div class="form-check mt-2">
                                        <input class="form-check-input" type="checkbox" name="is_asuransi_kesehatan" id="is_asuransi_kesehatan" value="1" {{ old('is_asuransi_kesehatan', $penduduk->is_asuransi_kesehatan) ? 'checked' : '' }}>
                                ...
                                <div class="col-md-4 mb-3">
                                    <div class="form-check mt-2">
                                        <input class="form-check-input" type="checkbox" name="is_disabilitas" id="is_disabilitas" value="1" {{ old('is_disabilitas', $penduduk->is_disabilitas) ? 'checked' : '' }} onchange="toggleDisabilitas(this)">
                                        <label class="form-check-label fw-bold" for="is_disabilitas">Penyandang Disabilitas</label>
                                    </div>
                                </div>

                                <div class="col-md-4 mb-3" id="jenis_disabilitas_wrapper" style="{{ old('is_disabilitas', $penduduk->is_disabilitas) ? '' : 'display: none;' }}">
                                    <label class="form-label" for="jenis_disabilitas">Jenis Disabilitas</label>
                                    <input type="text" class="form-control" id="jenis_disabilitas" name="jenis_disabilitas" value="{{ old('jenis_disabilitas', $penduduk->jenis_disabilitas) }}" placeholder="Contoh: Tuna Netra, Tuna Rungu" />
                                </div>
                            </div>
                            ...
                            <div class="row border-top pt-3 mt-3">
                                ...
                                <div class="col-md-8 mb-3">
                                    ...
                                    <textarea class="form-control" id="keterangan" name="keterangan" rows="2">{{ old('keterangan', $penduduk->keterangan) }}</textarea>
                                </div>
                            </div>
                        </div>

                        <div class="card-footer bg-light d-flex justify-content-end gap-2 p-3">
                            <a href="{{ route('admin.keluarga.show', $penduduk->keluarga_id) }}" class="btn btn-outline-secondary">
