                    ...
                    <div class="card h-100 mb-4">
                        ...
                        <div class="card-body pt-3">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="nik" name="nik" value="{{ old('nik') }}" maxlength="16" placeholder="16 digit NIK" inputmode="numeric" autocomplete="off" />
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <div class="form-check form-check-inline mt-2">
                                        <input class="form-check-input" type="radio" name="jenis_kelamin" id="jk_l" value="laki-laki" {{ old('jenis_kelamin', 'laki-laki') == 'laki-laki' ? 'checked' : '' }}>
                                        <label class="form-check-label" for="jk_l">Laki-laki</label>
                                    </div>
                                    <div class="form-check form-check-inline mt-2">
                                        <input class="form-check-input" type="radio" name="jenis_kelamin" id="jk_p" value="perempuan" {{ old('jenis_kelamin') == 'perempuan' ? 'checked' : '' }}>
