                ...
                <form action="{{ route('admin.keluarga.update', $keluarga->id) }}" method="POST">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control" id="kode_pos" name="kode_pos" value="{{ old('kode_pos', $keluarga->kode_pos) }}" inputmode="numeric" autocomplete="off" />
                        </div>
                        <div class="col-md-6 mb-3">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const oldRtRwId = "{{ old('rt_rw_id', $keluarga->rt_rw_id) }}";
