...
<div class="row">
    <div class="col-12 col-md-8 offset-md-2">
        <h4 class="fw-bold py-3 mb-4">
            <span class="text-muted fw-light">Kategori Pengaduan /</span> Tambah Kategori
        </h4>
            ...
            <div class="card-body">
                ...
                <form action="{{ route('admin.kategori-pengaduan.store') }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="icon" name="icon" value="{{ old('icon') }}" placeholder="Contoh: bx-message-detail, bx-wrench" />
