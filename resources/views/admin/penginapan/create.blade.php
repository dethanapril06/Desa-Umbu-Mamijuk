                ...
                <form action="{{ route('admin.penginapan.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control" id="nama_penginapan" name="nama_penginapan" value="{{ old('nama_penginapan') }}" placeholder="Contoh: Homestay Asri Ibu Adri" required />
                        </div>
                        <div class="col-md-6 mb-3">
                    ...
                    <div class="mb-4">
                        <label class="form-label" for="foto">Foto Penginapan</label>
